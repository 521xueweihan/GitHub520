...
52.188.204.90                 avatars2.githubusercontent.com
...
上面内容会自动定时更新，保证最新有效。数据更新时间：2020-07-26T14:12:56+08:00（内容无变动不会更新）
...
4. ChangeHosts.py程序中默认您已经写入了github host，如模板中所示，如果您没有写，可以通过自己添加或修改源码大约30~34行的内容。
## 三、效果对比
之前的样子：
